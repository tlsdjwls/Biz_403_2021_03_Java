...
public class Controller_02 {
	...
	public static void main(String[] args) {
		...
		// intNum에 감긴 값이 3의 배수이면서 5의 배수이냐?
		// %3 == 0 AND %5 == 0 이냐?
		...
		// intNum 에 담긴 값이 3의 배수이거나 (또는) 5의 배수이냐?
		// || OR 연산자
		bYes = intNum % 3 == 0 || intNum % 5 ==0;
		/*
		 * 관계 연산자
		...
		bYes = true && true ; //true 1 * 1 = 1 : true 
		bYes = true && false ;//false 1 * 0 = 0 : false
		bYes = false && true ;//false
		bYes = false && false ;//false
		
		// ||(filter 기호) OP 는 true : 1, false 0으로 덧셈을 연상한다.
