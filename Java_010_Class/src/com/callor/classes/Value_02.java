...
import java.util.Scanner;
 ...
 /*
  * null 값
  * 프로그래밍 , 정보처리에서는 어떤 항목의 데이터가 있는가 없는가를 
  * 판단해야하는 경우가 있다
  * 
  ...
  *  wrapper class 사용하,여 선언되ㅐㄴ 변수는 null 값을 사용하여 선언된 변수는
  *  null 을 저장할 수 있다
  */
...
public class Value_02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(">> ");
		//키보드에서 숫자를 입력하고 Enter 를 누르면
		// 값이 num 변수에 저장되고 다음 코드가 실행
		//Integer num = scan.nextInt();
		//System.out.println(num);
		
		
		//키보드에서 문자열을 입력하고 Entre를 누르면 값이 str 변수에
		// 저장이 되고 다음 코드가 실행
		// 그냥 Entre 눌러도 입력을 종료하고 다음 코드가 실행
