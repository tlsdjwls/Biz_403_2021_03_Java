...
public class App_07 {
	...
	public static void main(String[] args) {
		 ...
		 *  
		 *  최초 : 7 , 2, 4, 3 ,1 일때 
		 *  0번 요소(7) , 1번 요소(2) 두가지를 크기 비교 0번에 2를 저장, 1에 7을 저장하여 자리바꿈
		 *  2, 7, 4, 3, 1 로 만듦
		 *  
		 *  0번 요소(2) , 2번요소(4) 이 두값을 크기 비교
		 *  4가 더 큰 값이므로 그냥 둔다
		 *  2 , 7 , 4 , 3 , 1 로 유지
		 *  
		...
		for(int num : intNums) {
			...
			System.out.println();
			System.out.println("====================");
			System.out.println("오름차순 정력(작->큰");
			System.out.println("--------------------");
			/*
			 * intNums[0]에 저장된 값과
			 * intNums[1]에 저장된 값을 교환
			 * 두 변수의 값을 서로 바꾸려면 (교환) 제 3의 임시저장소 변수가 필요하다
			 *  temp : 임시 저장 변수
			 */
			int t = intNums[0];
			intNums[0] = intNums[1];
