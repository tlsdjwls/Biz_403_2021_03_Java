...
/*
  ...
  *  객체 자체만으로는 어떤 역활을 수행하지 않는다
  *  다만 , method 에 매개변수로 전달할때는 거의 변수와 같이 사용된다.
  */
public class ScoreEX_04 {
	...
	public static void main(String[] args) {
		...
		ScoreServiceV2 sServiceV2 = new ScroeServiceV2();
		...
		// mathod 를 호출하여 return 한 결과를 또다른 method 에 
        // 매개 변수로 전달하는 코드의 예
